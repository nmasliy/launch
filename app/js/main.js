...
/* harmony import */ var _components_table_accordion__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/table-accordion */ "./src/js/components/table-accordion.js");
...
/* harmony import */ var _components_validation__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/validation */ "./src/js/components/validation.js");
/* harmony import */ var _components_fslightbox__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/fslightbox */ "./src/js/components/fslightbox.js");
...
(0,_functions_accordion__WEBPACK_IMPORTED_MODULE_0__.initAccordion)('.accordion__head', '.accordion__item');
...
function initWhySlider() {
  ...
  const whySwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.why__slider', {
    spaceBetween: 50,
    navigation: {
      prevEl: '.why__prev',
      nextEl: '.why__next'
    ...
    on: {
      slideChange(swiper) {
        const prevActiveItem = document.querySelector('.why-pagination__item.is-active');
  ...
  const simpleBar = new simplebar__WEBPACK_IMPORTED_MODULE_1__["default"](paginationScroll);
  simpleBar.getScrollElement().addEventListener('scroll', function (e) {
    const activeItem = document.querySelector('.why-pagination__item.is-active');
...
/***/ "./src/js/components/table-accordion.js":
/*!**********************************************!*\
  !*** ./src/js/components/table-accordion.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _functions_table_accordion__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../functions/table-accordion */ "./src/js/functions/table-accordion.js");
/* harmony import */ var _functions_table_accordion__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_functions_table_accordion__WEBPACK_IMPORTED_MODULE_0__);
...
const afterSend = () => {};
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.consult__form', rules, afterSend);
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.modal-form__form', rules2, afterSend);
...
/***/ "./src/js/functions/table-accordion.js":
/*!*********************************************!*\
  !*** ./src/js/functions/table-accordion.js ***!
  \*********************************************/
/***/ (() => {
...
function initTabs(triggerSelector, parentSelector) {
  ...
  if (triggerNodes.length > 0 && parentNodes.length > 0) {
    const needInit = triggerNodes.every(triggerNode => !triggerNode.classList.contains('is-active'));
    if (needInit) {
...
const validateForms = (selector, rules, afterSend) => {
  ...
  if (telSelector) {
    const inputMask = new (inputmask__WEBPACK_IMPORTED_MODULE_1___default())('+7 (999) 99-99-99', {
